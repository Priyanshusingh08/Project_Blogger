                    ...
                    >
                      ...
                      <Stack spacing={2} direction="row">
                        ...
                        <Button
                          variant="contained"
                          color="error"
                          onClick={(e) => navigate("/main/browsing")}
                        >
                          Browse
                        </Button>
                      </Stack>
            ...
            <section className="mb-10">
              ...
              <div className="row gx-lg-5 mb-5 align-items-center">
                ...
                <div className="col-md-6 mb-4 mb-md-0">
                  ...
                  <p className="text-muted">
                    ...
                    non-profit organizations. Business types range from limited
                    liability companies, sole proprietorships, corporations, and
                    partnerships.
                  </p>
                  <p className="text-muted">
                    A business is an organization where people work together. In
                    a business, people work to make and sell products or
                    services. Other people buy the products and services. The
                    business owner is the person who hires people for work. A
                    business can earn a profit for the products and services it
                    offers.
                  </p>
                  <a
              ...
              <div className="row gx-lg-5 mb-5 flex-lg-row-reverse align-items-center">
                ...
                <div className="col-md-6 mb-4 mb-md-0">
                  ...
                  <p className="text-muted">
                    Your exhibition stand needs to attract prospects, leave an
                    impression, and make an impact with visitors. Follow these
                    tips to plan an exhibition stand that helps your business
                    stand out and achieve your marketing goals. Goals and
                    Audience Before we begin... read more
                  </p>
                  <a
                    className="btn btn-primary"
                    href="#"
            ...
            <section className="mb-10">
              ...
              <div className="row gx-lg-5 align-items-center mb-5">
                ...
                <div className="col-md-6 mb-4 mb-md-0">
                  ...
                  <p className="text-muted">
                    Today is Jerusalem Day, the 55th anniversary of the
                    liberation of the Temple Mount and reunification of the holy
                    city of Jerusalem during the 1967 Six Day War. The day of
                    Jerusalem’s liberation from 19 years of illegal Jordanian
                    occupation was June 7th – the 28th day of the Hebrew month
                    of Iyar, which is today.
                  </p>
                </div>
              </div>
              ...
              <div className="row gx-lg-5 align-items-center mb-5">
                ...
                <div className="col-md-6 mb-4 mb-md-0">
                  ...
                  <p className="text-muted">
                    Understand every aspect of the global economy – and know how
                    to make your next move. Get unlimited digital access on
                    Bloomberg.com or The Bloomberg App. Monthly Discount.
                    Unlimited Access. Yearly Discount. Instant Access. Print and
                    Mobile Access. Student Offer.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="mb-10 text-center">
              <div className="row">
                <div className="col-lg-3 col-md-6 mb-5 mb-lg-0 position-relative">
                  <i
                    className="fas fa-cubes fa-3x text-danger mb-4"
                    aria-controls="#picker-editor"
                  ></i>
                ...
                <div className="col-lg-3 col-md-6 mb-5 mb-lg-0 position-relative">
                  <i
                    className="fas fa-layer-group fa-3x text-danger mb-4"
                    aria-controls="#picker-editor"
                  ></i>
                ...
                <div className="col-lg-3 col-md-6 mb-5 mb-lg-0 position-relative">
                  <i
                    className="fas fa-image fa-3x text-danger mb-4"
                    aria-controls="#picker-editor"
                  ></i>
                ...
                <div className="col-lg-3 col-md-6 mb-4 mb-lg-0 position-relative">
                  <i
                    className="fas fa-plug fa-3x text-danger mb-4"
                    aria-controls="#picker-editor"
                  ></i>
                    ...
                    <div className="col-lg-5 mb-4 mb-lg-0">
                      <form>
                        ...
                        <button
                          ...
                          aria-controls="#picker-editor"
                          onClick={() => window.alert("Message Send")}
                        >
                          Send
                        </button>
                      </form>
